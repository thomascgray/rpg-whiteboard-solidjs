  ...
  for (let i = 0; i < num; i++) {
    ...
    newObjects[i] = _.sample([
      ...
      // },
      {
        ...
        url: "https://i.imgur.com/TWBguf5.png",
        hasSelfResized: false,
        zIndex: i,
        type: eObjectType.IMAGE,
...
export const makeDummyObjects2 = (num: number, spacingFactor: number) => {
  const newObjects: { [key: string]: iObject } = {};
